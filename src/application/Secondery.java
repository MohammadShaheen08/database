...
public class Secondery extends BorderPane {
	...
	public Secondery() {
		...
		Button companyButton = createStyledButton("Company Orders", "🏬");
		...
		contentBox.getChildren().addAll(titleText, buyMedicineButton, sellMedicineButton, saleOrderButton, medicineButton,employeesButton,companyButton,logOut);
