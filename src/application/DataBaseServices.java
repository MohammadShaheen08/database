...
public class DataBaseServices {
	...
	public static ArrayList<SaleOrder> getAllSaleOrders() throws SQLException, ClassNotFoundException {
		...
		while (rs.next()) {
			...
			// Assuming you have an Order class, create an Order object and add it to the
			// list
	...
	public static ArrayList<Company> getAllCompany() throws ClassNotFoundException, SQLException {
		...
		while (rs.next()) {
			...
			String establsihDate = rs.getString("establsihDate");
	...
	public static ArrayList<Medicine> getMedicinesInSaleOrder(int orderId) throws SQLException, ClassNotFoundException {
		...
		// Iterate through the result set and fetch Medicine objects for each medicine
		// ID
		while (rs.next()) {
	...
	public static void addOrderFromCompany(ArrayList<Medicine> medicines) throws ClassNotFoundException, SQLException {
		...
		try {
			...
			// Step 1: Insert into orderfromcompany table
			...
			// Step 2: Insert into orderfromcompany_medicine table
			...
			// Execute batch insert for orderfromcompany_medicine
	...
	public static void deleteCompanyOrder(int orderId) throws SQLException, ClassNotFoundException {
		...
		try {
			...
			// Step 1: Delete from orderfromcompany_medicine table
			...
			// Step 2: Delete from orderfromcompany table
	...
	public static void connectDB() throws ClassNotFoundException, SQLException {
		...
		p.setProperty("password", "M1202541");
