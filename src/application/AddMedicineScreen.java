...
public class AddMedicineScreen extends Secondery {
	...
	public AddMedicineScreen() {
		...
		CompanycomboBox.getItems().add("187411");
		CompanycomboBox.getItems().add("656251");
		CompanycomboBox.getItems().add("865246");
		CompanycomboBox.getItems().add("952567");
		CompanycomboBox.getItems().add("984948");
		...
		InsertButton.setOnAction(e -> {
			...
			if (validateInput(idField, nameField, packageField, quantityField, dosageField, priceField,
				...
				Medicine newMedicine = new Medicine(id, name, pack, quantity, description, dosageForm, price, compId);
